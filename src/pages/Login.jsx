        ...
        <div className='h-[550px] flex justify-center items-center'>
            <div className='w-96'>
                ...
                <form onSubmit={handleSubmit(handleLogin)}>                    
                    ...
                    <div className="form-control">
                    <Link to="/forgotPassword" className=''><small className='text-xs'>Forgot password?</small></Link>
                    </div>
                ...
                <div className='text-center mt-3'>
                    <p className='text-center'><small>New to iBos task manager? <Link className='text-secondary' to="/signUp"> Registration</Link></small></p>
